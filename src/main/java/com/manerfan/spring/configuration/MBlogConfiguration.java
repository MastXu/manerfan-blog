...
import com.manerfan.spring.configuration.web.ListenerConfiguration;
import com.manerfan.spring.configuration.web.mvc.SpringMVCConfiguration;
import com.manerfan.spring.configuration.web.security.SpringSecurityConfiguration;
...
@ComponentScan(basePackages = "com.manerfan", excludeFilters = {
        ...
        @Filter(type = FilterType.ANNOTATION, value = Configuration.class) }) /* 不扫描spring javaconfig相关 */
@Import({ ListenerConfiguration.class, /* web listener */
        FilterConfiguration.class, /* web filter */
