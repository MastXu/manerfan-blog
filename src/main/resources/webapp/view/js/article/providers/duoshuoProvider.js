        ...
        if (o.extend = function (e, t) {
                ...
                , W = S.loadRequire = function (t) {
                    if (t.visitor && (!nt.data && t.visitor.user_id && e.Notification && M.send({
                        ...
                        t.site && (rt.reset(t.site),
                            z.save("ds_site_" + c.short_name, t.site)),
                        !S.theme && rt.data.theme && n(rt.data.theme),
                        t.lang && (o.extend(D, t.lang),
                            z.save("ds_lang_" + c.short_name, t.lang)),
                            t.stylesheets)
            ...
            et.commentList = function (e) {
                ...
                et.ctxPost = function (e) {
                    ...
                    e.index >= 0 && (t += '<div class="ds-ctx-nth" title="' + S.fullTime(e.post.created_at) + '">' + (e.index + 1) + D.floor + "</div>"),
                        t += '</div><div class="ds-ctx-content">' + e.post.message,
                    e.index >= 0 && (t += '　　　　　　　<div class="ds-comment-actions',
                    e.post.vote > 0 && (t += " ds-post-liked"),
                        t += '">' + et.likePost(e.post) + '<a class="ds-post-repost" href="javascript:void(0);"><span class="ds-icon ds-icon-share"></span>' + D.repost + '</a><a class="ds-post-reply" href="javascript:void(0);"><span class="ds-icon ds-icon-reply"></span>' + D.reply + "</a></div>"),
                        t += "</div></div></li>"),
                        t
                }
                ,
                ...
                et.post = function (e) {
                    ...
                    if (t += "<p>",
                        s.parents.length >= i.max_depth && (!i.show_context || i.max_depth > 1) && s.parent_id && lt[s.parent_id] && (t += '<a class="ds-comment-context" data-post-id="' + s.post_id + '" data-parent-id="' + s.parent_id + '">' + D.reply_to + u(lt[s.parent_id].toJSON().author.name) + ": </a>"),
                        ...
                        s.vote > 0 && (t += " ds-post-liked"),
                            ...
                            "duoshuo" == s.source ? (t += '<a class="ds-post-reply" href="javascript:void(0);"><span class="ds-icon ds-icon-reply"></span>' + D.reply + "</a>" + et.likePost(s) + '<a class="ds-post-repost" href="javascript:void(0);"><span class="ds-icon ds-icon-share"></span>' + D.repost + '</a><a class="ds-post-report" href="javascript:void(0);"><span class="ds-icon ds-icon-report"></span>' + D.report + "</a>",
                            s.privileges["delete"] && (t += '<a class="ds-post-delete" href="javascript:void(0);"><span class="ds-icon ds-icon-delete"></span>' + D["delete"] + "</a>")) : ("qqt" == s.source || "weibo" == s.source) && (t += '<a class="ds-weibo-comments" href="javascript:void(0);">' + D.comments,
                            s.type.match(/\-comment$/) || (t += '(<span class="ds-count">' + s.comments + "</span>)"),
                                t += '</a><a class="ds-weibo-reposts" href="javascript:void(0);">' + D.reposts,
                ...
                et.replybox = function (e) {
                    ...
                    if (t += r() ? ' href="javascript:void(0);" onclick="return false"' : ' href="' + S.REMOTE + "/settings/avatar/" + x(T()) + '" target="_blank" title="设置头像"',
                            t += ">" + et.avatarImg(nt.data) + '</a><form method="post">' + tt(e.params) + '<div class="ds-textarea-wrapper ds-rounded-top"><textarea name="message" title="Ctrl+Enter快捷提交" placeholder="' + u(D.leave_a_message) + '"></textarea><pre class="ds-hidden-text"></pre>',
                            t += "</div>",
                    ...
                    X.mouseenter(N).mouseleave(I),
                        ...
                        st.RelatedRead.prototype = {
                            ...
                            _unpackImages: function (e) {
                                for (var t, s = e.image_list.slice(0, 3), a = []; s.length;)
                                    t = s.shift(),
                                ...
                                !function t() {
                                    clearTimeout(e._count_timer),
                                        e.el.find(".ds-reads-date").each(function () {
                                            var e, t, s, a, i, r, n = H(this).data("date"), o = (new Date).getTime(), d = o - n, l = new Date(n);
                                            d > 864e5 ? (e = l.getFullYear(),
                                                t = l.getMonth() + 1,
                                                s = l.getDate(),
                                                H(this).html(e + "年" + t + "月" + s + "日")) : d > 36e5 ? (a = Math.floor(d / 60 / 60 / 1e3),
                                                H(this).html(a + "小时前")) : d > 6e4 ? (i = Math.floor(d / 60 / 1e3),
                                                H(this).html(i + "分钟前")) : (r = Math.floor(d / 1e3),
                                                H(this).html(r + "秒前"))
                                        }),
                        ...
                        st.EmbedThread = Q.extend({
                            ...
                            onload: function (t) {
                                ...
                                t.options && t.options.show_recommend && (a.relatedRead = new st.RelatedRead,
                                    a.relatedRead.load(t.thread.thread_id),
