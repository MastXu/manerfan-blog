...
<head>
    ...
    <style>
        ...
        .menu-img {
            background-image: url(<c:url value="/view/images/editor/menu.png" />);
...
<div class="content">
    <div class="slide modal-body" id="slide1">
        ...
        <div class="centered logo transition transparent scale">
            <img src="<c:url value="/view/images/editor/logo.svg" />" />
            ...
            <div class="subtitle transition transparent scale">
                ...
                <div class="social">
                    ...
                    <a href="https://monetizejs.com/authorize?client_id=ESTHdCYOi18iLhhO&summary=true"
                       target="_blank"><img src="<c:url value="/view/images/editor/button.svg" />"></a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <br>
                    <br>
                    <img class="img modal-content" width="600" src="<c:url value="/view/images/editor/syntax-highlighting.gif" />">
                </div>
                <div class="col-md-4 col-md-offset-1">
                    <h2 id="rich-markdown-editor">Rich markdown editor</h2>

                    <p>StackEditâs markdown syntax highlighting is unique. The refined text formatting of the editor
                        helps you
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <p>StackEditâs Scroll Sync extension accurately binds the scrollbars of the editor panel and the
                        preview panel to ensure that you always keep an eye on the output while writing.</p>
                </div>
            </div>
            <br>
            <br>
            <img class="img modal-content" width="600" src="<c:url value="/view/images/editor/live-preview.png" />">
            <br>
            <br>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-1">
                    ...
                    <p>StackEdit uses browserâs built-in spell-checker to perform efficient, multi-language
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <p>StackEdit offers infinite combinations of settings. Theme, layout, shortcuts can be
                        personalized. For the rest, StackEdit gives you the freedom to make your own extensionâ¦</p>
                </div>
            </div>
            <br>
            <br>
    ...
    <div id="slide3" class="modal-footer modal-header">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <img class="img modal-content" width="600" src="<c:url value="/view/images/editor/publish.png" />">
                </div>
                <div class="col-md-4 col-md-offset-1">
                    <br>
                    ...
                    <p>StackEdit can upload your documents directly to Blogger, GitHub, Tumblr, WordPressâ¦ You can
                        choose
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-md-offset-1">
                    <img class="img" width="600" src="<c:url value="/view/images/editor/comments.png" />">
                </div>
            </div>
            <div class="row">

                <div class="col-md-7">
                    <img class="img" width="600" src="<c:url value="/view/images/editor/conflict.png" />">
                </div>
                <div class="col-md-4 col-md-offset-1">
                    <br>
    ...
    <div class="modal-body">
        <img class="background-img img" width="500" src="<c:url value="/view/images/editor/toc.gif" />">
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-1">
                    <img class="img" width="410" src="<c:url value="/view/images/editor/code-block.png" />">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-1">
                    <img class="img" width="330" src="<c:url value="/view/images/editor/math.png" />">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-1">
                    <img class="img" width="220" src="<c:url value="/view/images/editor/diagram.png" />">
                </div>
            </div>
            <br>
            <br>
